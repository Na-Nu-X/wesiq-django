...
export function toggleLike(icon, counter, id) {
    icon.addEventListener("click", function() {
        ...
        if(icon.classList.contains("fa-regular")) {
            ...
            counter.textContent = parseInt(counter.textContent) + 1 // Adds 1 Like To The Counter By Clicking On The Empty Heart
        ...
        // If The Heart Is Already Clicked
            ...
            counter.textContent = parseInt(counter.textContent) - 1 // Subtracts 1 Like To The Counter By Clicking On The Already Clicked Heart
...
export function toggleReply(icon, form) {
    icon.addEventListener("click", function() {

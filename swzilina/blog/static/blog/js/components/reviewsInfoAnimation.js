...
export function reviewsInfoAnimation() {
    ...
    let total_reviews_amount = [...reviews_graph_columns].reduce((sum, one_column) => sum + parseInt(one_column.querySelector(".counter").dataset.amount), 0) // Gets Total Amount Of Reviews

...
document.addEventListener("DOMContentLoaded", function():void {
    ...
    const content:HTMLDivElement = document.querySelector(".content") as HTMLDivElement // Gets Content Container

    const new_training_plan:HTMLDivElement = content.querySelector(".new_training_plan") as HTMLDivElement // Gets New Training Plan
    const training_plan:HTMLDivElement = new_training_plan.querySelector(".training_plan") as HTMLDivElement // Gets Training Plan

    const drop_zone:HTMLDivElement = training_plan.querySelector(".drop_zone") as HTMLDivElement // Gets Training Plan Drop Zone

    const day_select_menu:HTMLDivElement = new_training_plan.querySelector(".additional_info .day_select_menu") as HTMLDivElement // Gets Day Select Menu
    ...
    const save:HTMLButtonElement = new_training_plan.querySelector(".save") as HTMLButtonElement // Gets Training Plan Save Button

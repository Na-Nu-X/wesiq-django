...
export function showPassword(icon, input) {
    ...
    input.style.webkitTextSecurity = "none"; // Shows Password (input.style.webkitTextSecurity = "none")
}
...
export function hidePassword(icon, input) {
    ...
    input.style.webkitTextSecurity = "disc"; // Hides Password (input.style.webkitTextSecurity = "disc")
}

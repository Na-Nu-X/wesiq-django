...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateStars(hover_value = 0) {
        stars.forEach(function (star, index) {
            if (hover_value > 0)
                index < hover_value ? star.src = "../../static/images/star.png" : star.src = "../../static/images/empty_star.png";
            else
                index < selected_rating ? star.src = "../../static/images/star.png" : star.src = "../../static/images/empty_star.png";
        });
    }
    stars.forEach(function (star, index) {

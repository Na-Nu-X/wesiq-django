...
document.addEventListener("DOMContentLoaded", function():void {
    ...
    training_plan.addEventListener("dragover", function(event:DragEvent):void {
        ...
        if(event.target === training_plan.querySelectorAll<HTMLDivElement>(".exercise")[edit_training_plan_state.active_exercise_index]) event.preventDefault() // Drop Zone On Active Exercise In The Training Plan (Makes The Drop Zone Functional)
    ...
    training_plan.addEventListener("drop", function(event:DragEvent):void {
        if(event.target === drop_zone) addExercise(training_plan, edit_training_plan_state) // Drop Zone For The First Exercise (Adds Dragged Exercise From Exercise Selection To The Training Plan)
        if(event.target === training_plan.querySelectorAll<HTMLDivElement>(".exercise")[edit_training_plan_state.active_exercise_index]) addExercise(training_plan, edit_training_plan_state) // Drop Zone On Active Exercise In The Training Plan (Adds Dragged Exercise From Exercise Selection To The Training Plan) 
